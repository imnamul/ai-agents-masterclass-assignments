...
🕐 Expected response: {2 if context.tier != "basic" else 4} hours
    """.strip()
...
def process_refund_request(
    ...
    """
    processing_days = 3 if context.tier != "basic" else 5
...
def initiate_return_process(
    ...
    return_label_fee = 0 if context.tier != "basic" else 5.99
